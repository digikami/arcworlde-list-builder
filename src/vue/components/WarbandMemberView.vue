  ...
  <div class="warband_member_view mb-5">
    <div class="character_grid text-center my-3">
      <div class="character_grid-header bg-dark text-white p-3">
        <h2 class="h4 m-0">{{ member.get('name') }} <span v-if="member.get('name') != member.get('character').get('name')">({{ member.get('character').get('name')}})</span> &mdash; <span class="text-nowrap">{{ member.totalCost(list.get('faction')) }} GP</span></h2>
      </div>
